...
const handleBookLessonClick = (slug) => {
  if (!isPreview.value) return;
  if (!slug) return;
  navigateTo(`/lesson-book/schedule/${slug}`);
};
      ...
      >
        ...
        >
          <div
            ...
            :key="localIndex"
            class="flex flex-col items-start h-full rounded-lg cursor-pointer"
          ...
          >
            ...
            <p
              :class="[
                ...
                'outline-none',
                {
                  'border border-dashed border-gray-300 min-h-[1em] rounded':
                    isEditing,
            ...
            <!-- Price -->
            <p v-if="teacher.price > 0" class="mt-2">
              <span
        ...
        <div v-if="hasTeachers || isEditing" class="space-y-4 mb-6">
          ...
          >
            ...
            <div class="flex-1 min-w-0">
              ...
              <!-- Book Lesson Button -->
              <Button
                :label="`Book Lesson with ${teacher.name || 'Irene'}`"
                size="small"
                rounded
